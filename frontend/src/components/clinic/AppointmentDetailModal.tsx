...
const AppointmentDetailModal: React.FC<AppointmentDetailModalProps> = ({ appointment, onClose }) => {
 ...
 <p className="text-2xl font-black text-[#CBFF38] bg-black px-3 py-1 rounded-xl">
 ...
 <span className="text-gray-900 font-black uppercase">{appointment.appointmentSource}</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-sm font-bold text-amber-900 leading-relaxed">"{appointment.notes}"
 </p>
 </div>
 )}
 ...
 <p className="text-sm font-bold text-blue-900 leading-relaxed">"{appointment.clinicNotes}"
 </p>
 </div>
 )}
 ...
 <p className="text-sm font-bold text-emerald-900 leading-relaxed">"{appointment.appointmentCompletionReport.notes}"
 </p>
 </div>
 )}
 ...
 <p className="text-sm font-bold text-gray-600 leading-relaxed">"{appointment.treatmentDetails.notes}"
 </p>
 </div>
 )}
 </div>
