...
const AppointmentExecutionModal: React.FC<AppointmentExecutionModalProps> = ({
 ...
 <p className={`text-xs font-black uppercase ${selectedServiceIds.includes(s.id) ? 'text-green-900' : 'text-gray-900'}`}>
 ...
 <div className="flex items-center justify-between p-3 bg-white/50 rounded-lg border border-amber-100">
