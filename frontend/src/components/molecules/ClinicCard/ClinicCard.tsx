...
export const ClinicCard: React.FC<ClinicCardProps> = ({
 ...
 <div className="bg-[#CBFF38] text-black px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl">
 ELITE_PARTNER
 </div>
 </div>
 ...
 <h3 className="text-2xl sm:text-4xl font-black tracking-tighter text-white mb-2 leading-none">
 {clinic.name}
 </h3>
 <div className="flex items-center gap-3 text-[8px] sm:text-[10px] font-black uppercase tracking-widest text-[#CBFF38]">
 ...
 <span className="text-[9px] font-bold text-gray-400 uppercase mt-1">premium protocol</span>
 </div>
 ...
 <button
 className="flex-1 h-14 border border-white/10 text-white hover:bg-white hover:text-black rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all"
 onClick={(e) => { e.stopPropagation(); onSelect?.(clinic); }}
 >
 View Profile
 </button>
 <button
 className="flex-1 h-14 bg-[#CBFF38] text-black hover:bg-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all shadow-xl flex items-center justify-center gap-2"
 onClick={(e) => { e.stopPropagation(); onSelect?.(clinic); }}
 >
 Book Now
 </button>
