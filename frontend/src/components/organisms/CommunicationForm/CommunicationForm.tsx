...
export const CommunicationForm: React.FC<CommunicationFormProps> = ({
 ...
 <h3 className="text-xs font-black uppercase tracking-widest text-[#CBFF38]">Interaction Architecture</h3>
 </div>
 ...
 <h3 className="text-xs font-black uppercase tracking-widest text-[#CBFF38]">Telemetry Details</h3>
 </div>
 ...
 <h3 className="text-xs font-black uppercase tracking-widest text-[#CBFF38]">Case Observations</h3>
 </div>
 <div className={inputContainerStyle}>
 ...
 <span className="text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-white/60 transition-colors">Queue Follow-up Task</span>
 </label>
 ...
 <span className="text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-white/60 transition-colors">Initialize Booking</span>
 </label>
 </div>
 )}
 ...
 type="button" 
 onClick={onCancel}
 className="px-8 h-12 rounded-xl text-[10px] font-black uppercase tracking-widest text-white/30 hover:text-white hover:bg-white/5 transition-all"
 >
 Abort
 </button>
 <button 
 ...
 className="px-10 h-12 bg-[#CBFF38] text-black rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-[0_10px_30px_rgba(203,255,56,0.3)] disabled:opacity-50"
 >
 {isSubmitting ? (
