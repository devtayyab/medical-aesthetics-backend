...
export const SalesDiary: React.FC<SalesDiaryProps> = ({ salespersonId }) => {
 ...
 <div className="text-[11px] font-black text-slate-900 uppercase truncate tracking-tight">{member.firstName}</div>
 ...
 <div className="text-[10px] font-black text-slate-900 uppercase tracking-tighter leading-none flex items-center gap-1.5 truncate">
 {getIcon()}
 {act.title}
 </div>
