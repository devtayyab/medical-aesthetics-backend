...
export const CustomerDetails: React.FC<CustomerDetailsProps> = ({
 ...
 <span className="text-slate-400 text-xs">No clinic assigned</span>
 )}
 <Button
 variant="outline"
 size="sm"
 ...
 {actions.length === 0 && (
 <div className="text-center py-6 text-slate-400 text-sm">No tasks assigned.</div>
 )}
 </div>
 </CardContent>
 </Card>
 ...
 {call.notes || <span className="text-slate-400 font-normal">No notes provided.</span>}
 </p>
 {call.salesperson && (
