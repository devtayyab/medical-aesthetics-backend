...
export const searchClinics = createAsyncThunk("client/searchClinics",
 async (
...
export const fetchFeaturedClinics = createAsyncThunk("client/fetchFeaturedClinics",
...
export const fetchClinicById = createAsyncThunk("client/fetchClinicById",
...
export const fetchClinicServices = createAsyncThunk("client/fetchClinicServices",
...
export const fetchAvailability = createAsyncThunk("client/fetchAvailability",
 async (
 params: {
 clinicId: string;
 serviceId: string;
...
export const holdSlot = createAsyncThunk("client/holdSlot",
 async (
 data: {
 clinicId: string;
 serviceId: string;
...
export const createAppointment = createAsyncThunk("client/createAppointment",
 async (
 data: {
 clinicId: string;
 serviceId: string;
...
export const fetchUserAppointments = createAsyncThunk("client/fetchUserAppointments",
 async (_, { getState, rejectWithValue }) => {
 try {
 const state = getState() as RootState;
 console.log("fetchUserAppointments: Using accessToken:",
 ...
 console.error("fetchUserAppointments: Error:",
...
export const cancel = createAsyncThunk("client/cancelAppointment",
...
export const reschedule = createAsyncThunk("client/rescheduleAppointment",
 async (
 {
 appointmentId,
 newStartTime,
...
export const fetchLoyaltyBalance = createAsyncThunk("client/fetchLoyaltyBalance",
...
export const fetchLoyaltyHistory = createAsyncThunk("client/fetchLoyaltyHistory",
 async (clientId: string, { rejectWithValue }) => {
 try {
...
export const redeemPoints = createAsyncThunk("client/redeemPoints",
 async (
 data: {
 clientId: string;
 clinicId: string;
...
export const submitReview = createAsyncThunk("client/submitReview",
 async (
