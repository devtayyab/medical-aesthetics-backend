...
export const createNewUser = createAsyncThunk("admin/createNewUser",
 async (userData: any) => {
...
export const updateUserDetails = createAsyncThunk("admin/updateUserDetails",
...
export const toggleUserStatus = createAsyncThunk("admin/toggleUserStatus",
 async (id: string) => {
...
export const fetchLoyaltyTiers = createAsyncThunk("admin/fetchLoyaltyTiers",
 async () => {
...
export const updateLoyaltyTiers = createAsyncThunk("admin/updateLoyaltyTiers",
