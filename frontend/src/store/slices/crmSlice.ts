...
// Lead Management
export const createLead = createAsyncThunk("crm/createLead",
 async (data: {
 source: string;
 firstName: string;
 lastName: string;
...
export const fetchLeads = createAsyncThunk("crm/fetchLeads",
...
export const updateLead = createAsyncThunk("crm/updateLead",
...
export const deleteLead = createAsyncThunk("crm/deleteLead",
 async (id: string) => {
...
export const getCustomerRecord = createAsyncThunk("crm/getCustomerRecord",
...
export const fetchCustomer = createAsyncThunk("crm/fetchCustomer",
...
export const updateCustomerRecord = createAsyncThunk("crm/updateCustomerRecord",
...
// Communication Management
export const logCommunication = createAsyncThunk("crm/logCommunication",
...
export const updateCommunication = createAsyncThunk("crm/updateCommunication",
...
export const deleteCommunication = createAsyncThunk("crm/deleteCommunication",
 async (id: string) => {
...
export const fetchCommunicationHistory = createAsyncThunk("crm/fetchCommunicationHistory",
...
// Action/Task Management
export const createAction = createAsyncThunk("crm/createAction",
...
export const updateAction = createAsyncThunk("crm/updateAction",
...
export const deleteAction = createAsyncThunk("crm/deleteAction",
 async (id: string) => {
...
export const fetchActions = createAsyncThunk("crm/fetchActions",
...
export const fetchPendingActions = createAsyncThunk("crm/fetchPendingActions",
...
export const fetchOverdueTasks = createAsyncThunk("crm/fetchOverdueTasks",
 async (salespersonId?: string) => {
...
export const fetchTasks = createAsyncThunk("crm/fetchTasks",
 async (salespersonId?: string) => {
...
export const fetchTaskKpis = createAsyncThunk("crm/fetchTaskKpis",
 async (salespersonId?: string) => {
...
// Duplicate Management
export const checkForDuplicates = createAsyncThunk("crm/checkForDuplicates",
...
export const fetchClinics = createAsyncThunk("crm/fetchClinics",
 async () => {
...
export const getDuplicateSuggestions = createAsyncThunk("crm/getDuplicateSuggestions",
 async (data: { email?: string; phone?: string; firstName?: string; lastName?: string }) => {
...
export const mergeDuplicates = createAsyncThunk("crm/mergeDuplicates",
...
// Tag Management
export const addCustomerTag = createAsyncThunk("crm/addCustomerTag",
...
export const removeCustomerTag = createAsyncThunk("crm/removeCustomerTag",
 async (id: string) => {
...
export const fetchCustomersByTag = createAsyncThunk("crm/fetchCustomersByTag",
...
// Task Automation
export const fetchAutomationRules = createAsyncThunk("crm/fetchAutomationRules",
 async () => {
...
export const runTaskAutomationCheck = createAsyncThunk("crm/runTaskAutomationCheck",
 async () => {
...
// Field Validation
export const getRequiredFieldsForCall = createAsyncThunk("crm/getRequiredFieldsForCall",
 async () => {
...
export const getRequiredFieldsForAction = createAsyncThunk("crm/getRequiredFieldsForAction",
...
export const validateCommunication = createAsyncThunk("crm/validateCommunication",
...
export const validateAction = createAsyncThunk("crm/validateAction",
...
export const getCustomer = createAsyncThunk("crm/getCustomer",
...
// Communication Management
export const getCommunicationHistory = createAsyncThunk("crm/getCommunicationHistory",
 async (data: { customerId: string; filters?: any }) => {
 const response = await crmAPI.getCommunicationHistory(data.customerId, data.filters);
 return response.data;
 }
...
export const handleFacebookWebhook = createAsyncThunk("crm/handleFacebookWebhook",
 async (data: any) => {
...
export const importFacebookLeads = createAsyncThunk("crm/importFacebookLeads",
...
export const getFacebookForms = createAsyncThunk("crm/getFacebookForms",
 async (pageId?: string) => {
...
export const fetchCrmMetrics = createAsyncThunk("crm/fetchCrmMetrics",
 async () => {
...
// Repeat Customer Management
export const fetchRepeatCustomers = createAsyncThunk("crm/fetchRepeatCustomers",
 async (salespersonId?: string) => {
...
export const fetchCustomersDueForFollowUp = createAsyncThunk("crm/fetchCustomersDueForFollowUp",
...
export const scheduleRecurring = createAsyncThunk("crm/scheduleRecurring",
 async (data: {
 customerId: string;
 clinicId: string;
 serviceId: string;
...
export const fetchSalespersons = createAsyncThunk("crm/fetchSalespersons",
 async () => {
...
export const fetchSalesActivities = createAsyncThunk("crm/fetchSalesActivities",
...
export const reassignCustomer = createAsyncThunk("crm/reassignCustomer",
...
export const fetchSuperAdminStats = createAsyncThunk("crm/fetchSuperAdminStats",
