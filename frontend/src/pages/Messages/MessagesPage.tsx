...
export const MessagesPage: React.FC = () => {
 ...
 <div>
 <h1 className="text-2xl font-black uppercase tracking-tighter mb-1">Transmission <span className="text-[#CBFF38]">Hub</span></h1>
 ...
 className="bg-[#CBFF38] text-black h-12 px-6 rounded-xl font-black uppercase tracking-widest text-[10px] flex items-center gap-2 hover:scale-105 transition-all shadow-lg"
 >
 ...
 className={`px-4 h-8 rounded-full text-[9px] font-black uppercase tracking-widest transition-all ${selectedTab === tab ? 'bg-[#CBFF38]/10 text-[#CBFF38] border border-[#CBFF38]/20' : 'bg-white/5 text-white/20'}`}
 >
 {tab}
 </button>
 ))}
 ...
 <h2 className="text-xl font-black uppercase tracking-widest mb-2 opacity-10">Select Transmission</h2>
