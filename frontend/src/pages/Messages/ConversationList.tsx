...
export const ConversationList: React.FC<ConversationListProps> = ({
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">No Active Channels Found</p>
 </div>
 ) : (
 ...
 <div className={`size-12 rounded-2xl flex items-center justify-center font-black text-sm transition-all ${isActive 
