...
import { Send, MoreVertical, Paperclip, Smile, ShieldCheck, Clock } from 'lucide-react';
...
export const ChatWindow: React.FC<ChatWindowProps> = ({ conversationId }) => {
 ...
 <div className="size-14 rounded-2xl bg-[#CBFF38] flex items-center justify-center text-black font-black text-xl shadow-lg group-hover:rotate-6 transition-transform">
 ...
 <h3 className="font-black text-white uppercase tracking-tighter leading-none text-xl">
 ...
 <p className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-500 mt-2 flex items-center gap-2">
 ...
 <p className="text-[13px] leading-relaxed font-bold z-10 relative">{msg.content}</p>
 </div>
 ...
 className="w-full h-16 pl-8 pr-20 bg-gray-100/50 border-none rounded-3xl text-sm font-bold text-gray-900 focus:ring-2 focus:ring-black transition-all shadow-inner placeholder: placeholder:font-black placeholder:uppercase placeholder:text-gray-300 placeholder:tracking-widest"
 value={content}
 ...
 className={`absolute right-3 top-1/2 -translate-y-1/2 h-10 px-6 rounded-2xl transition-all flex items-center gap-2 font-black uppercase text-[10px] tracking-widest ${content.trim()
