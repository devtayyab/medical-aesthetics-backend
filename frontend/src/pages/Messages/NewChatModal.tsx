...
export const NewChatModal: React.FC<NewChatModalProps> = ({ onClose }) => {
 ...
 className="px-6 py-2 bg-[#CBFF38] text-black text-[10px] font-black uppercase tracking-widest rounded-xl hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#CBFF38]/20"
 >
 ...
 <span className={`text-[9px] font-black uppercase tracking-widest bg-black/5 px-2 py-0.5 rounded transition-colors ${isSelected ? 'text-black bg-black/10' : 'text-[#CBFF38] group-hover:bg-[#CBFF38]/20 group-hover:text-[#CBFF38]'}`}>{user.role?.replace('_', ' ')}</span>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Enter parameters to scan neural registry</p>
 </div>
 )}
 </AnimatePresence>
 </div>
