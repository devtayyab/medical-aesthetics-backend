...
export const Notifications: React.FC = () => {
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Alert Registry</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Notifications</h1>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Accessing notification protocols...</p>
 </div>
 ...
 <h3 className="text-lg font-black uppercase tracking-tighter text-gray-900 mb-2">Registry Empty</h3>
 <p className="text-sm text-gray-400 font-medium max-w-xs uppercase text-[10px]">You have no active alerts in the system core at this moment.</p>
 </div>
 ) : (
 ...
 <h3 className={`text-xs font-black uppercase tracking-widest ${!notif.isRead ? 'text-black' : 'text-gray-900'}`}>
 {notif.title}
 </h3>
