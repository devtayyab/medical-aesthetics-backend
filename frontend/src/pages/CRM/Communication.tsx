...
export const Communication: React.FC = () => {
 ...
 <span className="text-[8px] font-black uppercase tracking-widest text-white/20">Registry</span>
 ...
 <h3 className="font-black uppercase text-xs tracking-tight truncate">{contact.name}</h3>
 ...
 <p className={`text-[10px] ${selectedCustomerId === contact.id ? 'text-gray-500' : 'text-white/20'} truncate font-bold`}>{contact.email || contact.phone || 'ID: '+contact.id.slice(0,6)}</p>
 </div>
 </div>
 </div>
 ))}
 ...
 className={`px-5 h-9 rounded-full text-[9px] font-black uppercase tracking-widest transition-all ${selectedTab === tab ? 'bg-[#CBFF38]/10 text-[#CBFF38] border border-[#CBFF38]/20' : 'bg-white/5 text-white/20 border border-transparent'}`}
 >
 {tab}
 </button>
 ))}
 ...
 <h2 className="text-lg font-black uppercase tracking-tight mb-1 truncate w-full">{activeContact.name}</h2>
 <p className="text-[10px] font-bold text-[#CBFF38] uppercase">{activeContact.type} NODE</p>
 </div>

 <div className="flex flex-col gap-2 mb-6">
 <button 
 onClick={() => setShowPushModal(true)}
 className="w-full h-11 bg-white/5 rounded-xl flex items-center justify-center gap-3 text-white/40 hover:bg-[#CBFF38] hover:text-black transition-all font-black uppercase text-[10px] tracking-widest border border-white/5"
 >
 ...
 className="w-full h-10 mb-4 bg-[#CBFF38]/10 text-[#CBFF38] border border-[#CBFF38]/20 rounded-xl text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#CBFF38] hover:text-black transition-all"
 >
 ...
 <span className="text-[9px] font-black truncate max-w-[140px] text-white/60">{activeContact.email || 'Closed'}</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-[8px] font-bold text-white/20 uppercase">Transmission Count</span>
 <span className="text-[9px] font-black text-white/60">{communications.length} Units</span>
 </div>
 </div>
 
 <div className="pt-2">
 <div className="flex justify-between items-center mb-2">
 <h4 className="text-[8px] font-black uppercase tracking-widest text-[#CBFF38]">Next Protocol</h4>
 <Clock size={10} className="text-white/20" />
 </div>
 <div className="p-3 bg-black/20 rounded-xl text-[9px] font-bold text-white/30">No scheduled operations</div>
 </div>
 </div>

 <button 
 onClick={() => { setEditingLog(null); setShowForm(true); }}
 className="w-full h-12 bg-[#CBFF38] text-black rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 mt-6 hover:scale-[1.02] transition-all"
 >
 ...
 <label className="text-[10px] font-black uppercase text-white/20 ml-2">Broadcast Title</label>
 <input 
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black uppercase text-white/20 ml-2">Message Payload</label>
 <textarea 
 ...
 disabled={isPushing}
 className="w-full h-14 bg-[#CBFF38] text-black rounded-2xl font-black uppercase tracking-widest mt-4 hover:scale-[1.02] active:scale-95 transition-all shadow-[0_10px_30px_rgba(203,255,56,0.2)] disabled:opacity-50"
 >
