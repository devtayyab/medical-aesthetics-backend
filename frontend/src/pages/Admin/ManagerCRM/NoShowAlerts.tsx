...
export const NoShowAlerts: React.FC = () => {
 ...
 return (
 <div className={cn("inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider",
 ...
 cell: ({ row }: any) => (
 <span className="text-xs text-gray-500">{row.original.actionRecommended}</span>
 )
 },
 {
 id:"actions",
 ...
 <p className="text-[10px] text-gray-500 mt-1">"85% recovery rate via voice follow-up"</p>
 </CardContent>
 </Card>
 </div>
