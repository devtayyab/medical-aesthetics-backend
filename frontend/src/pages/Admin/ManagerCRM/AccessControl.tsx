...
export const AccessControl: React.FC = () => {
 ...
 className={cn("flex items-center gap-2 px-4 py-2 rounded-2xl border text-[11px] font-black tracking-tight transition-all active:scale-95 group",
 c.hasAccess
 ...
 <CardContent>
 <div className="text-4xl font-black text-slate-800">{totalAgents}</div>
 ...
 <CardContent>
 <div className="text-4xl font-black text-slate-800">{totalClinicsCount}</div>
 ...
 <CardContent>
 <div className="text-4xl font-black text-slate-800">{privateClinicsCount}</div>
 <div className="flex items-center gap-2 mt-2">
 ...
 <div>
 <CardTitle className="text-xl font-black text-slate-800 uppercase tracking-tight">Security Policy mapping</CardTitle>
