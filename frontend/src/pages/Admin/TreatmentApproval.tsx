...
export const TreatmentApproval: React.FC = () => {
 ...
 <p className="text-sm font-black text-gray-400 uppercase tracking-widest mb-1">Short Description</p>
 <p className="text-gray-700 font-medium">{treatment.shortDescription || 'No short description provided.'}</p>
 </div>
 </div>

 <div className="mb-8">
 <p className="text-sm font-black text-gray-400 uppercase tracking-widest mb-1">Full Details</p>
