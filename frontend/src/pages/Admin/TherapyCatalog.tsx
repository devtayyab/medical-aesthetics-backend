...
export const TherapyCatalog: React.FC = () => {
 ...
 <h3 className="font-black text-gray-900 uppercase tracking-tighter text-lg leading-tight group-hover:text-[#CBFF38] transition-colors line-clamp-1">{t.name}</h3>
 </div>
 </div>
 ...
 <p className="text-gray-500 text-sm line-clamp-2 mb-6 font-medium leading-relaxed border-l-2 border-gray-100 pl-4">
 ...
 <div className="flex items-center gap-3">
 <div className="size-10 bg-gray-50 rounded-xl flex items-center justify-center text-gray-800 font-black">
 {cat.icon || cat.name.charAt(0)}
 </div>
 <div>
 <h4 className="font-black text-gray-900 uppercase tracking-tight">{cat.name}</h4>
 ...
 <p className="text-sm font-black text-gray-900 uppercase">{item.categoryRef?.name || item.category}</p>
 </div>
 <div>
 ...
 <p className="text-sm text-gray-700 font-medium">"{item.shortDescription || 'No summary provided.'}"</p>
 </div>
 <div>
 ...
 <h3 className="text-2xl font-black text-gray-900 uppercase tracking-tighter">{editingItem ?"Edit Category" :"New Category"}</h3>
 </div>
 ...
 <p className="text-[10px] text-gray-400 ml-1">Pick a parent to make this a subcategory. Leave as top-level otherwise.</p>
 </div>
 <div className="space-y-2">
