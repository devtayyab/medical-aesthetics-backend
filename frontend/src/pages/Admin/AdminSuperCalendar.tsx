        ...
        <div className="flex h-full w-full bg-gray-50 relative overflow-hidden rounded-xl border border-gray-200 shadow-sm flex-col">
            ...
            <div className="bg-white border-b border-gray-200 p-4 lg:p-6">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-black text-gray-900 tracking-tight flex items-center gap-2 uppercase italic">
            ...
            <div className="bg-white border-b border-gray-100 px-4 py-3 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-xl">
                    ...
                    <span className="text-[11px] font-black text-gray-700 min-w-[140px] text-center uppercase italic px-2">
                        {viewMode === 'week'
                ...
                <div className="flex items-center gap-3 flex-1 lg:flex-none">
                    <div className="relative group min-w-[180px]">
                        ...
                        <select
                            ...
                            className="w-full bg-gray-50 border border-gray-100 text-gray-900 rounded-xl pl-9 pr-8 py-2.5 text-[10px] font-black uppercase italic appearance-none focus:ring-2 focus:ring-black transition-all"
                        >
                    ...
                    {weekDays.map(day => (
                        <div key={day.toISOString()} className={`relative border-r border-gray-100 ${isToday(day) ? 'bg-[#CBFF38]/5' : ''}`}>
                            <div className="h-12 border-b border-gray-100 flex flex-col items-center justify-center sticky top-0 bg-white/95 backdrop-blur-sm z-10">
                                <span className={`text-[10px] font-black uppercase italic tracking-tighter ${isToday(day) ? 'text-black' : 'text-gray-400'}`}>{format(day, 'EEEE')}</span>
                ...
                <div className="fixed inset-y-0 right-0 w-[400px] bg-white shadow-2xl z-[100] border-l border-gray-100 flex flex-col transform transition-transform duration-300">
                    <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-black text-[#CBFF38]">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-lg font-black uppercase italic italic tracking-tighter">Command Detail</h2>
                        </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-8 no-scrollbar">
                        <section>
                            ...
                            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="size-12 bg-black text-[#CBFF38] rounded-xl flex items-center justify-center text-lg font-black italic">
                        ...
                        <section className="space-y-3">
                            ...
                            <Button 
                                ...
                                className="w-full bg-black text-[#CBFF38] hover:bg-zinc-800 font-black uppercase italic py-6 rounded-xl flex items-center justify-center gap-3"
                            >
                                <Move className="w-5 h-5" /> Reassign Customer
                            </Button>
                            <Button 
                                onClick={() => setIsRecurringModalOpen(true)}
                                className="w-full bg-white text-black border border-gray-200 hover:bg-gray-50 font-black uppercase italic py-6 rounded-xl flex items-center justify-center gap-3"
                            >
                                <RefreshCw className="w-5 h-5" /> Set Recurring
                            </Button>
                            <Button 
                                onClick={() => navigate(`/crm/customer/${selectedApt.clientId}`)}
                                className="w-full bg-indigo-600 text-white hover:bg-indigo-700 font-black uppercase italic py-6 rounded-xl flex items-center justify-center gap-3"
                            >
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4">
                    <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl">
                        <div className="p-6 bg-black text-[#CBFF38] flex items-center justify-between">
                            <h3 className="text-xl font-black uppercase italic">Reassign Customer</h3>
                        ...
                        <div className="p-8 space-y-6">
                            <div className="space-y-2">
                                ...
                                <select 
                                    ...
                                    className="w-full bg-gray-50 border border-gray-100 p-4 rounded-2xl font-black uppercase italic"
                                >
                            ...
                            <div className="flex gap-4">
                                <Button onClick={() => setIsReassignModalOpen(false)} className="flex-1 bg-gray-100 text-gray-500 font-black uppercase italic py-4 rounded-xl">Cancel</Button>
                                <Button onClick={handleReassign} className="flex-1 bg-black text-[#CBFF38] font-black uppercase italic py-4 rounded-xl">Confirm Transfer</Button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {isRecurringModalOpen && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4">
                    <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl">
                        <div className="p-6 bg-black text-[#CBFF38] flex items-center justify-between">
                            <h3 className="text-xl font-black uppercase italic">Schedule Recurring</h3>
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <Button onClick={() => setIsRecurringModalOpen(false)} className="flex-1 bg-gray-100 text-gray-500 font-black uppercase italic py-4 rounded-xl">Cancel</Button>
                                <Button onClick={handleScheduleRecurring} className="flex-1 bg-black text-[#CBFF38] font-black uppercase italic py-4 rounded-xl">Initialize Schedule</Button>
                            </div>
                        </div>
                    </div>
                </div>
