...
export const TreatmentDetails: React.FC = () => {
 ...
 className="text-[#CBFF38] font-black tracking-[1em] text-[10px] uppercase"
 >
 Analyzing Protocol...
 </motion.div>
 </div>
 ...
 <p className="text-[11px] md:text-xs text-gray-400 leading-relaxed mb-6 max-w-lg">
 ...
 className="px-6 h-12 bg-white/5 border border-white/10 text-white rounded-xl font-black text-[9px] uppercase tracking-[0.2em] hover:bg-white/10 transition-all flex lg:hidden items-center justify-center gap-2"
 >
 ...
 <h4 className="text-lg sm:text-xl font-black tracking-tight text-gray-900 group-hover:text-[#CBFF38] transition-colors leading-tight mb-2">
 {offering.clinicName}
 </h4>
 ...
 <div className="flex items-center justify-end text-xl sm:text-2xl font-black text-gray-900 leading-none mb-0 sm:mb-1">
 ...
 className="w-full h-14 bg-[#121212] text-[#CBFF38] rounded-xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-[#CBFF38] hover:text-black transition-all shadow-md active:scale-95 flex items-center justify-center gap-2"
 >
 ...
 <h3 className="text-[9px] font-black uppercase tracking-[0.4em] text-[#CBFF38] bg-black px-3 py-1 rounded-md shrink-0">In-depth Protocol</h3>
 <div className="h-px bg-gray-200 flex-1"></div>
 </div>
