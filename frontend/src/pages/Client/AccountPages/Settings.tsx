...
export const Settings: React.FC = () => {
 ...
 <div className="flex items-center gap-3 mb-8 text-gray-400 text-[11px] font-black uppercase tracking-[0.2em]">
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.3em]">Parameters Updated</span>
 </motion.div>
 )}
 </AnimatePresence>
 ...
 <p className="font-black uppercase text-gray-900 tracking-tight">{item.label}</p>
 </div>
 ...
 <p className="text-[9px] font-black uppercase tracking-[0.4em] opacity-50">Secure Clinical Environment</p>
 </div>
