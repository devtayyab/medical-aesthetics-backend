    ...
    <section className={sectionStyle}>
      <div className={containerStyle}>
        <div className={breadcrumbStyle}>
          <Link to="/my-account">Account</Link> / Wallet
        </div>
        <h2 className={headingStyle}>Wallet</h2>
        ...
        <div>
          <div className={detailRowStyle}>
            <label className={labelStyle}>Balance</label>
            <span className={valueStyle}>${balance}</span>
          </div>
          <Button
