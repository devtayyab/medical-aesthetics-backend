...
export const Blog: React.FC = () => {
 ...
 className={`w-full text-left px-5 py-3 rounded-xl transition-all text-[10px] font-black uppercase tracking-widest flex items-center justify-between group ${selectedCategoryId ==="All"
 ...
 className={`w-full text-left px-5 py-3 rounded-xl transition-all text-[10px] font-black uppercase tracking-widest flex items-center justify-between group ${selectedCategoryId === cat.id
 ? 'bg-black text-[#CBFF38] shadow-2xl'
 : 'text-gray-400 hover:text-black hover:bg-gray-50'
 }`}
 >
 ...
 <h3 className="text-xl font-black uppercase text-gray-900 mb-2">No Matches Found</h3>
 ...
 />
 <div className="absolute top-4 left-4 bg-black text-[#CBFF38] px-3 py-1 rounded-full text-[8.5px] font-black uppercase tracking-widest">
 ...
 <h3 className="text-xl font-black uppercase text-gray-900 mb-5 leading-tight group-hover:text-black line-clamp-2">
 {post.title}
 </h3>
