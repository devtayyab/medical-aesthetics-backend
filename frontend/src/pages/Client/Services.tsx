...
export const Services: React.FC = () => {
 ...
 <h3 className="text-2xl font-black tracking-tight text-gray-900 mb-4 group-hover:text-black">
 {service.name}
 </h3>
 <p className="text-gray-500 font-medium text-base mb-8 flex-1 leading-relaxed">
 {service.description}
 </p>
 <button
 ...
 <div className="flex items-center justify-center gap-2 mb-4 text-[#CBFF38] text-2xl font-black uppercase tracking-tight">
