...
export const BlogPost: React.FC = () => {
 ...
 <h2 className="text-5xl font-black uppercase tracking-tighter text-gray-900 mb-6">404: LOST IN SIGHT</h2>
 <button
 ...
 className="flex items-center gap-3 mb-10 text-gray-400 text-[11px] font-black uppercase tracking-[0.2em]"
 >
 ...
 >
 {post.category && (
 <div className="inline-flex items-center gap-2 bg-black text-[#CBFF38] px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-widest">
 <Tag size={12} /> {post.category.name}
 </div>
 )}
 
 <h1 className="text-4xl sm:text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.9] text-gray-900">
 {post.title}
 </h1>
 ...
 <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-lime-500">
 <Sparkles size={14} />
 ...
 <Link
 to="/blog"
 className="flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.3em] text-gray-400 hover:text-black transition-colors group"
 >
 ...
 className="flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.3em] text-gray-900 cursor-pointer group"
 >
 ...
 <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-8 text-center">Authored By</h4>
 ...
 <h3 className="text-xl font-black uppercase tracking-tighter text-gray-900">{post.author.firstName} {post.author.lastName}</h3>
 ...
 <p className="text-gray-400 text-xs mt-6 font-medium leading-relaxed">
 ...
 <h4 className="text-3xl font-black uppercase text-white tracking-tighter leading-none mb-6">Experience <br /> The Difference</h4>
 <p className="text-sm font-medium text-gray-400 leading-relaxed">Transform your aesthetic journey with our elite medical professionals.</p>
 </div>
