...
export const ClinicDetails: React.FC = () => {
 ...
 if (isLoading) return <div className="p-20 text-center text-gray-400 font-bold uppercase animate-pulse">Establishing Connection...</div>;
 ...
 <span className="text-white text-[11px] font-black uppercase tracking-widest ml-1 drop-shadow-md">
 {(clinicData.rating !== null && clinicData.rating !== undefined)
 ? Number(clinicData.rating).toFixed(1)
 :"4.9"} ({clinicData.reviewCount || 0} Reviews)
 </span>
 </div>
 <h1 className="text-white text-3xl sm:text-5xl font-black leading-[0.9] tracking-tighter drop-shadow-2xl">
 {clinicData.name}
 </h1>
 </div>
 </div>
 ...
 <div className="size-14 rounded-2xl bg-black text-[#CBFF38] flex items-center justify-center font-black text-xl">
 ...
 <h4 className="font-black text-gray-900 uppercase tracking-tight text-lg">
 ...
 <p className="text-gray-600 leading-relaxed border-l-[6px] border-[#CBFF38] pl-6 py-2 text-lg font-medium">"{review.comment}"
 </p>
 </div>
 ))}
 </div>
 ...
 <p className="text-gray-600 leading-relaxed text-xl font-medium relative z-10">{clinicData.description}</p>
 </div>
 ...
 <div>
 <h4 className="font-black uppercase text-base mb-1 tracking-tighter">Clinical Precision</h4>
 ...
 <div>
 <h4 className="font-black uppercase text-base mb-1 tracking-tighter text-gray-900">Elite Standing</h4>
 ...
 <div className="space-y-6">
 <div className={cardStyle}>
 <h3 className="text-xl font-black text-gray-900 uppercase mb-8 pb-4 border-b border-gray-50">Logistics & Range</h3>
 ...
 <div>
 <h4 className="font-black text-gray-900 uppercase text-xs mb-2 tracking-widest">Ground Coordinates</h4>
 ...
 <div>
 <h4 className="font-black text-gray-900 uppercase text-xs mb-2 tracking-widest">Operational Window</h4>
 <div className="space-y-2 mt-2">
 {['Mon - Fri / 09:00 - 20:00', 'Sat / 10:00 - 18:00', 'Sun / Standby Only'].map(hour => (
 <p key={hour} className="text-[10px] font-black uppercase text-gray-400 tracking-wider">{hour}</p>
 ))}
 </div>
 </div>
 </div>
 ...
 <h4 className="text-lg sm:text-xl font-black uppercase tracking-tighter leading-none">Transmission</h4>
 <p className="text-gray-400 text-[9px] font-black uppercase tracking-widest">{selectedServices.length} PRIVILEGES</p>
 </div>
 <div className="h-10 w-px bg-white/10 hidden sm:block" />
 <div className="text-right sm:text-left">
 <p className="text-[8px] font-black uppercase tracking-widest text-[#CBFF38] mb-0.5">Payload</p>
 ...
 className="flex-1 sm:flex-none h-12 sm:h-14 px-8 sm:px-10 bg-[#CBFF38] text-black font-black uppercase text-[11px] tracking-[0.2em] rounded-2xl shadow-xl hover:bg-white transition-all flex items-center justify-center gap-4 group"
 >
