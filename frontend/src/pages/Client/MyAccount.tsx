...
// Received new high-quality reception check-in image for dashboard
...
export const MyAccount: React.FC = () => {
 ...
 <h2 className="text-2xl md:text-3xl font-black uppercase text-white tracking-tighter leading-none mb-4">
 ...
 <p className="text-[9px] font-black uppercase tracking-widest leading-tight">Elite Care Protocol <br /><span className="text-gray-500">Personalized for you</span></p>
 </div>
 ...
 <div className="flex flex-col items-center md:items-end text-[9px] font-black uppercase tracking-[0.4em] text-gray-200">
