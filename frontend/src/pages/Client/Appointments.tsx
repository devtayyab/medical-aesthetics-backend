...
export const Appointments: React.FC = () => {
 ...
 <div className="relative pt-24 pb-64 overflow-hidden">
 ...
 <p className="text-gray-500 mt-8 font-bold text-base max-w-xl">
 ...
 <h3 className="text-2xl font-black uppercase text-gray-900 mb-4">No records found</h3>
 <p className="text-gray-400 text-sm font-bold uppercase tracking-widest mb-10">Your aesthetic calendar is currently clear.</p>
 <Link to="/search">
 <button className="px-12 h-16 bg-black text-[#CBFF38] text-[11px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-lime-500 hover:text-black transition-all shadow-2xl">
 ...
 <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest mb-3">Selected Procedure</p>
 <h3 className="text-2xl font-black uppercase text-gray-900 tracking-tighter leading-tight">
 ...
 <button onClick={() => handleRetryPayment(apt)} className="h-11 px-6 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest" title="Pay Now">
 ...
 <div className="absolute bottom-full right-0 mb-3 w-56 p-4 bg-black text-white text-[10px] font-medium rounded-2xl opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 pointer-events-none z-30 shadow-2xl border border-white/10 leading-relaxed">
 ...
 <Link to="/support" className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-300 hover:text-black transition-colors">Patient Concierge</Link>
 <Link to="/legal" className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-300 hover:text-black transition-colors">Privacy Compliance</Link>
 </div>
 <p className="text-[9px] font-black uppercase tracking-[0.4em] text-gray-200">© 2026 BEAUTY_DOCTORS_PROTOCOL</p>
 </footer>
 </div>
 );
};
