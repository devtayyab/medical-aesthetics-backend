...
export const Search: React.FC = () => {
 ...
 <h1 className={`text-white font-black tracking-tighter transition-all duration-700 mb-0 whitespace-nowrap ${isScrolled ? 'text-lg sm:text-2xl' : 'text-3xl sm:text-4xl lg:text-5xl mb-4 sm:mb-8'}`}>
 ...
 className={`text-[10px] sm:text-[12px] font-black uppercase tracking-widest whitespace-nowrap transition-all ${activeTab === 'treatments' ? 'text-black border-b-2 sm:border-b-4 border-[#CBFF38] pb-1' : 'text-gray-400'}`}
 >
 ...
 className={`w-full text-left px-4 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-gray-50 flex items-center justify-between transition-colors ${sortBy === opt.id ? 'text-[#CBFF38] bg-[#121212]' : 'text-gray-600'}`}
 >
 {opt.label}
 ...
 className={`w-full text-left px-4 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-gray-50 flex items-center justify-between transition-colors ${salonsFilter === type || (type === 'Any' && !salonsFilter) ? 'text-[#CBFF38] bg-[#121212]' : 'text-gray-600'}`}
 >
 {type}
 ...
 className={`w-full text-left px-4 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-gray-50 flex items-center justify-between transition-colors ${ratingFilter === opt.id || (opt.id === 'any' && ratingFilter === 'any') ? 'text-[#CBFF38] bg-[#121212]' : 'text-gray-600'}`}
 >
 {opt.label}
 ...
 <button onClick={() => setShowMobileMap(true)} className="bg-black text-[#CBFF38] h-14 px-6 sm:px-8 rounded-full shadow-2xl font-black uppercase tracking-widest text-[10px] flex items-center gap-2 sm:gap-3">
 ...
 <span className="font-black uppercase">Radar View</span>
