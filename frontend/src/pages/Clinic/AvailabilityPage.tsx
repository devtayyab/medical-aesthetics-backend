...
const AvailabilityPage: React.FC = () => {
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Syncing clinical configuration...</p>
 </div>
 );
 }
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Operational Status: Online</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Availability</h1>
 ...
 <span className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400">Clinic</span>
 <select
 ...
 <h2 className="text-lg font-black uppercase tracking-tighter text-gray-900">Working Hours</h2>
 </div>
 </div>
 ...
 <span className="text-[10px] font-black uppercase tracking-widest text-gray-900 group-hover: transition-all capitalize">{day}</span>
 </div>
 ...
 <span className="text-[9px] font-black uppercase tracking-widest text-gray-300">Clinic Closed</span>
 )}
 </div>
 ))}
 </div>
 ...
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 px-1">Timeline Configuration</p>
 <div className="relative">
 <select
 value={timezone}
 ...
 <h2 className="text-sm font-black uppercase tracking-tighter text-gray-900">Blackout Dates</h2>
 </div>

 <div className="space-y-4">
 <div className="relative">
 <p className="text-[8px] font-black uppercase tracking-widest text-gray-400 ml-2 mb-2">Add New Block</p>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-300">No Blocks</p>
 </div>
 ) : (
 ...
 <div className="flex items-center gap-3">
 <div className="size-8 rounded-lg bg-white flex items-center justify-center text-black font-black text-[10px] shadow-sm">
 ...
 <h2 className="text-sm font-black uppercase tracking-tighter text-white">Temporary Blocks</h2>
 </div>

 <div className="space-y-3 mb-6">
 <div className="space-y-1.5">
 <p className="text-[8px] font-black uppercase tracking-widest text-gray-500 ml-2">Date</p>
 <div className="relative">
 ...
 <p className="text-[8px] font-black uppercase tracking-widest text-gray-500 ml-2">Entry</p>
 <div className="relative">
 ...
 <div className="flex-1 space-y-1.5">
 <p className="text-[8px] font-black uppercase tracking-widest text-gray-500 ml-2">Exit</p>
 <div className="relative">
 <Clock className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 pointer-events-none" size={14} />
 <input
 type="time"
 ...
 className="w-full h-10 bg-white text-black hover:bg-[#CBFF38] rounded-xl flex items-center justify-center gap-2 transition-all font-black uppercase text-[9px] tracking-widest mt-2"
 >
 ...
 <div className="text-[10px] font-black text-[#CBFF38]">
