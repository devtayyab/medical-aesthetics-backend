...
const AppointmentsPage: React.FC = () => {
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Live Operations</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Appointments</h1>
 ...
 className="h-11 px-4 bg-gray-50 border-none rounded-xl focus:ring-1 focus:ring-black font-black uppercase text-[9px] tracking-widest appearance-none cursor-pointer min-w-[140px]"
 >
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Loading appointments...</p>
 </div>
 ...
 <h3 className="text-xl font-black uppercase tracking-tighter text-gray-900 mb-2">No Appointments</h3>
...
const AppointmentCard = ({ appointment, user, onConfirm, onCancel, onExecute, onReschedule, onNoShow, onOverview }: any) => {
 ...
 <span className="text-[7px] font-black">{fmt(startTime)}</span>
 </div>
 ...
 <h4 className="text-base font-black uppercase tracking-tighter text-red-700 mb-1">
 🚫 Blocked Time
 </h4>
 ...
 ? <span className="ml-2 text-red-400">· {appointment.reason || appointment.notes}</span>
 : null}
 </p>
 </div>
 ...
 {isPlatform && (
 <span className="px-2 py-0.5 bg-gray-900 text-[#CBFF38] text-[7px] font-black rounded-full uppercase tracking-widest">
 Diamond
 </span>
 )}
 ...
 <h4 className="text-sm font-black uppercase tracking-tighter text-gray-900 truncate">
 ...
 <button onClick={onOverview} className="h-9 px-4 bg-gray-100 text-gray-600 rounded-lg text-[9px] font-black uppercase tracking-widest hover:bg-black hover:text-white transition-all">
 Overview
 </button>
 </div>
 </div>
