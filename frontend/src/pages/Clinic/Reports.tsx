...
export const Reports: React.FC = () => {
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Compiling clinical reputation reports...</p>
 </div>
 );
 }
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#CBFF38]">Clinical Governance</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter leading-none">Operational Reports</h1>
 ...
 <div>
 <p className="text-xs font-black uppercase text-red-400 mb-1">System Error Detected</p>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-300">Patient Trust Score</p>
 </div>
 <h3 className="text-6xl font-black tracking-tighter text-black leading-none mb-2">
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-[#CBFF38]">Feedback Volume</p>
 </div>
 <div>
 <h3 className="text-6xl font-black tracking-tighter text-white leading-none mb-2">
 {reviewStats?.totalReviews || 0}
 </h3>
 <p className="text-xs font-bold text-gray-500">Verified clinical testimonials.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-xs font-black text-gray-400 group-hover:text-black transition-colors">{count}</span>
 </div>
 </div>
 )
 })}
 ...
 <div>
 <h4 className="text-lg font-black uppercase tracking-tighter leading-none mb-1">Export Executive Summary</h4>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest opacity-40">Last Sync Trace</p>
 <p className="text-xs font-black">T-{new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false })}</p>
 </div>
 </div>
 </div>
 )}
