...
const ClinicDashboard: React.FC = () => {
 ...
 <p className="text-gray-400 font-black text-[10px] uppercase tracking-widest">Syncing clinical data...</p>
 </div>
 );
 }
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Operational Overview</span>
 </motion.div>
 ...
 className="text-3xl md:text-5xl font-black text-gray-900 uppercase tracking-tighter leading-none"
 >
 ...
 <h3 className="text-lg font-black uppercase tracking-tighter text-gray-900">No active procedures</h3>
 ...
 <h3 className="text-xl md:text-2xl font-black uppercase tracking-tighter text-white">Advanced Metrics</h3>
 ...
 <h2 className="text-sm font-black uppercase tracking-tighter text-gray-900 mb-6 px-2">Operational Access</h2>
 ...
 <h4 className="text-lg font-black uppercase text-white tracking-tighter leading-tight">
 ...
 <h3 className="text-[9px] font-black uppercase tracking-widest text-gray-400 mb-5">System Insights</h3>
...
const StatCard = React.forwardRef(({ title, value, percentage, trend, icon, delay, highlight }: any, ref: any) => (
 ...
 <h3 className="text-2xl font-black uppercase tracking-tighter leading-none text-gray-900">{value}</h3>
 </div>
 </div>
 </motion.div>
));
...
const AppointmentPremiumRow = React.forwardRef(({ appointment, index, onClick }: any, ref: any) => {
 ...
 <span className="text-[10px] font-black">{new Date(appointment.startTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false })}</span>
 </div>
 </div>

 <div>
 <div className="flex items-center gap-2 mb-0.5">
 <h4 className="font-black uppercase tracking-tighter text-gray-900 group-hover:text-black text-sm">
 {appointment.client?.firstName} {appointment.client?.lastName}
 </h4>
 {isBeautyDoctors && (
 <span className="text-[7px] font-black bg-[#CBFF38] text-black px-1.5 py-0.5 rounded-full tracking-widest">DIAMOND</span>
 )}
 </div>
