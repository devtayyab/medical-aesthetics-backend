...
const ReviewsPage: React.FC = () => {
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Public Feedback Analysis</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Trust Matrix</h1>
 ...
 <span className="text-[9px] font-black uppercase tracking-widest text-gray-400">Curation Active</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Syncing feedback protocols...</p>
 </div>
 ) : reviews.length === 0 ? (
 ...
 <h3 className="text-xl font-black uppercase tracking-tighter text-gray-900 mb-2">Matrix is Silent</h3>
 ...
 <div className="size-14 rounded-2xl bg-black text-[#CBFF38] flex items-center justify-center font-black text-xl shadow-md">
 ...
 <div className="bg-gray-50/50 p-6 rounded-3xl border border-gray-50 mb-8 text-gray-700 font-medium leading-relaxed relative">
 ...
 <div>
 <p className="text-[10px] font-black uppercase tracking-widest text-[#CBFF38] mb-2">Official Clinic Response</p>
 <p className="text-sm font-medium leading-relaxed mb-4 text-gray-300">{review.response}</p>
 <p className="text-[8px] font-black uppercase text-gray-500 tracking-widest">Signal logged on {new Date(review.respondedAt!).toLocaleDateString()}</p>
 </div>
 </div>
 </motion.div>
 ...
 className="group h-12 px-6 bg-white border-2 border-black text-black rounded-2xl flex items-center gap-3 font-black uppercase text-[10px] tracking-[0.2em] hover:bg-black hover:text-[#CBFF38] transition-all"
 >
...
const StatCard = ({ title, value, icon, highlight }: any) => (
 ...
 {highlight && <div className="text-[7px] font-black text-gray-400 uppercase tracking-widest">Active Ops</div>}
 </div>
 <div>
 ...
 <h3 className="text-xl font-black uppercase tracking-tighter text-gray-900 leading-none">{value}</h3>
 </div>
 </div>
);
