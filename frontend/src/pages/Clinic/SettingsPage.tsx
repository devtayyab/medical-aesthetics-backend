...
const SettingsPage: React.FC = () => {
 ...
 <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Accessing clinical registry settings...</p>
 </div>
 );
 }
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Core Configuration</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Global Settings</h1>
 ...
 <h2 className="text-lg font-black uppercase tracking-tighter text-gray-900">Entity Profiling</h2>
 </div>

 <div className="space-y-8">
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Legal Identity *</p>
 <input
 type="text"
 value={formData.name ||""}
 ...
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Clinical Abstract / Biography</p>
 <textarea
 ...
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Primary Voice Line *</p>
 ...
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Transmission Email *</p>
 <div className="relative">
 ...
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Digital Domain (Website)</p>
 <div className="relative">
 ...
 <h2 className="text-lg font-black uppercase tracking-tighter text-gray-900">Visual Branding</h2>
 </div>

 <div className="space-y-8">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
 <div className="space-y-4">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Clinic Profile Photo</p>
 <ImageUpload 
 value={formData.photoUrl ||""} 
 onChange={(url) => setFormData({ ...formData, photoUrl: url })} 
 />
 <p className="text-[9px] text-gray-400 font-medium">This image will represent your clinic in search results.</p>
 </div>
 
 <div className="space-y-4">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Gallery Asset (Hero Image)</p>
 <ImageUpload 
 value={formData.images?.[0] ||""} 
 onChange={(url) => setFormData({ ...formData, images: [url] })} 
 />
 <p className="text-[9px] text-gray-400 font-medium">The primary high-fidelity visual for your profile page.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-lg font-black uppercase tracking-tighter text-gray-900">Geographical Origin</h2>
 </div>

 <div className="space-y-6">
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Street Protocol Address</p>
 <input
 type="text"
 ...
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Region / City</p>
 <input
 type="text"
 ...
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">State/Prov</p>
 <input
 type="text"
 ...
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Postal Code</p>
 <input
 type="text"
 ...
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Sovereign Nation (Country)</p>
 <input
 type="text"
 ...
 <div>
 <h2 className="text-lg font-black uppercase tracking-tighter text-gray-900">Payment Payout Details</h2>
 ...
 {/* IBAN */}
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">IBAN Number *</p>
 <input
 type="text"
 ...
 {/* Account Holder */}
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Account Holder Name *</p>
 <input
 type="text"
 ...
 {/* Bank Name */}
 <div className="relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">Bank Name</p>
 <input
 type="text"
 ...
 {/* BIC / SWIFT */}
 <div className="md:col-span-2 relative group">
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-3 ml-1">BIC / SWIFT Code</p>
 <input
 type="text"
 ...
 <h3 className="text-sm font-black uppercase tracking-tighter text-white">Registry Status</h3>
 </div>
 
 <div className="space-y-3">
 <div className="flex items-center justify-between p-3.5 bg-white/5 rounded-xl border border-white/10">
 <span className="text-[8px] font-black uppercase tracking-widest text-gray-500">Operations</span>
 <span className="text-[9px] font-black text-[#CBFF38] uppercase">Standard</span>
 </div>
 <div className="flex items-center justify-between p-3.5 bg-white/5 rounded-xl border border-white/10">
 <span className="text-[8px] font-black uppercase tracking-widest text-gray-500">Data Sync</span>
 <span className="text-[9px] font-black text-[#CBFF38] uppercase">100% Verified</span>
 </div>
 </div>

 <p className="text-[9px] font-bold text-gray-600 mt-6 leading-relaxed uppercase opacity-60">
 ...
 <h4 className="text-[9px] font-black uppercase tracking-widest text-gray-400 group-hover:text-white">Clinical Branding</h4>
 <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform group-hover:text-[#CBFF38]" />
 </div>
 <p className="text-[10px] font-bold leading-tight uppercase text-gray-600 group-hover:text-gray-400 opacity-70">
 Manage clinical logos and brand assets.
 </p>
 </div>

 <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm">
 <h4 className="text-[9px] font-black uppercase tracking-widest text-gray-400 mb-6">Security Access</h4>
