...
const NotificationsPage: React.FC = () => {
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Communication Hub</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Campaign Outreach</h1>
 ...
 <span className="text-[9px] font-black uppercase tracking-widest text-gray-400">Antenna Uplink Live</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-lg font-black uppercase tracking-tighter text-gray-900">Message Architect</h2>
 </div>

 <div className="space-y-8">
 {/* Method Selection */}
 <div>
 <p className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 mb-4 ml-1">Delivery Vector</p>
 ...
 <p className="text-[10px] font-black uppercase leading-none mb-1">Push System</p>
 ...
 <div className="text-left">
 <p className="text-[10px] font-black uppercase leading-none mb-1">Email Vector</p>
 ...
 <p className="text-[8px] font-black text-gray-300 uppercase tracking-widest">{message.length} Characters</p>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-sm font-black uppercase tracking-tighter text-gray-900">Patient Database</h3>
 </div>
 <div className="flex items-center gap-3">
 <button onClick={selectAll} className="text-[7px] font-black text-blue-500 uppercase tracking-widest hover:underline">All</button>
 <button onClick={deselectAll} className="text-[7px] font-black text-gray-400 uppercase tracking-widest hover:underline">None</button>
 </div>
 </div>
 ...
 >
 <div className={`size-9 rounded-xl flex items-center justify-center font-black shadow-sm transition-all ${
 isSelected ? 'bg-[#CBFF38] text-black scale-90' : 'bg-gray-50 text-gray-900'
 }`}>
 {client.firstName?.[0] || '?' }
 </div>
 <div className="flex-1 min-w-0">
 <p className={`text-[10px] font-black uppercase tracking-tighter truncate ${isSelected ? 'text-white' : 'text-gray-900'}`}>
 ...
 <div className="p-5 bg-gray-50 shrink-0 border-t border-gray-100">
 ...
 <h4 className="text-[8px] font-black uppercase tracking-widest text-black mb-1.5">Safety Protocol</h4>
 <p className="text-[10px] font-bold text-black leading-tight opacity-70">
