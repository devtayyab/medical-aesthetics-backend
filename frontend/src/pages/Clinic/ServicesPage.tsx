...
const ServicesPage: React.FC = () => {
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400">Catalog Management</span>
 </div>
 <div className="space-y-1">
 <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none text-gray-900">Treatments & Pricing</h1>
 ...
 <p className="text-[9px] font-black uppercase tracking-widest text-gray-400">Processing Registry...</p>
 </div>
 ) : services.length === 0 ? (
 ...
 <h3 className="text-lg font-black uppercase tracking-tighter text-gray-900 mb-2">Registry Offline</h3>
...
const ServiceCard = ({ service, canManage, onToggle, onEdit }: any) => {
 ...
 <div>
 <h3 className="text-lg font-black uppercase tracking-tighter text-gray-900 leading-none group-hover:translate-x-1 transition-transform mb-1.5">{service.treatment?.name}</h3>
 <p className="text-[8px] font-black uppercase tracking-widest text-gray-400">Deploy v4.0</p>
 </div>

 <p className="text-gray-500 text-[11px] font-medium line-clamp-2 leading-tight">
 ...
 <span className="text-[10px] font-black text-gray-900 uppercase">{service.durationMinutes}m</span>
 </div>
 ...
 <button
 onClick={onEdit}
 className="mt-4 w-full h-10 bg-gray-50 hover:bg-black hover:text-[#CBFF38] rounded-xl flex items-center justify-center gap-2 transition-all font-black uppercase text-[9px] tracking-widest"
 >
 <Edit2 size={12} />
 Parameters
 </button>
...
const ServiceModal: React.FC<ServiceModalProps> = ({
 ...
 <h3 className="text-sm font-black text-blue-900 uppercase tracking-tighter">Selection Workflow</h3>
 </div>
