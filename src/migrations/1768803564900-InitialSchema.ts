...
export class InitialSchema1768803564900 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create enums
        if (!(await typeExists('tasks_type_enum'))) {
        ...
        if (!(await typeExists('tasks_status_enum'))) {
        ...
        if (!(await typeExists('leads_status_enum'))) {
        ...
        if (!(await typeExists('appointments_status_enum'))) {
        ...
        if (!(await tableExists('loyalty_ledger'))) {
          await queryRunner.query(
        ...
        if (!(await typeExists('notifications_type_enum'))) {
        ...
        if (!(await typeExists('users_role_enum'))) {
        ...
        if (!(await tableExists('communication_logs'))) {
          await queryRunner.query(
        ...
        if (!(await tableExists('customer_tags'))) {
          await queryRunner.query(
        ...
        if (!(await tableExists('ad_campaigns'))) {
          await queryRunner.query(
        ...
        if (!(await tableExists('ad_attributions'))) {
          await queryRunner.query(
        ...
        if (!(await typeExists('customer_records_customerstatus_enum'))) {
        ...
        if (!(await tableExists('customer_records'))) {
          await queryRunner.query(
        ...
        if (!(await typeExists('crm_actions_actiontype_enum'))) {
        ...
        if (!(await indexExists('IDX_62fd8c2a24d920f1f23aa312e3'))) {
          await queryRunner.query(`CREATE INDEX "IDX_62fd8c2a24d920f1f23aa312e3" ON "audit_logs" ("resource", "createdAt")`);
        }
        if (!(await indexExists('IDX_99e589da8f9e9326ee0d01a028'))) {
        ...
        if (!(await tableExists('appointment_holds'))) {
          await queryRunner.query(
        ...
        if (!(await tableExists('lead_tags'))) {
          await queryRunner.query(
        ...
        if (!(await constraintExists('FK_27b517d1d7a2efe28177e98fdba'))) {
        ...
        if (!(await constraintExists('FK_3a30b5301edbd2e57e032961e9f'))) {
        ...
        if (!(await constraintExists('FK_72299eb2e42a1f560d44be97d04'))) {
        ...
        if (!(await constraintExists('FK_3117a13727ec3247fa47cc40e95'))) {
        ...
        if (!(await constraintExists('FK_040a7ee2072d45bc98efddf3c02'))) {
        ...
        if (!(await constraintExists('FK_f77953c373efb8ab146d98e90c3'))) {
        ...
        if (!(await constraintExists('FK_2428e01f899c4edb909e8798b63'))) {
        ...
        if (!(await constraintExists('FK_c4dbd8eb292b83b5dc67be3cf45'))) {
        ...
        if (!(await constraintExists('FK_7cf5739ef8c93bdaa98b5dca07e'))) {
        ...
        if (!(await constraintExists('FK_5bfebb90af9317731de682e6673'))) {
        ...
        if (!(await constraintExists('FK_db873ba9a123711a4bff527ccd5'))) {
        ...
        if (!(await constraintExists('FK_1142607b5a447cd5ce23ef7798f'))) {
        ...
        if (!(await constraintExists('FK_4992b11665bf79df55c6afde4da'))) {
        ...
        if (!(await constraintExists('FK_fcd6b2cb16b4efdd745e426a021'))) {
        ...
        if (!(await constraintExists('FK_8b2101f9c8689c8ec8a0e4469c2'))) {
        ...
        if (!(await constraintExists('FK_d52f7d2360abb04a9a966a6a268'))) {
        ...
        if (!(await constraintExists('FK_4f77ce6ee0977b68f3ec8b3cfe2'))) {
        ...
        if (!(await constraintExists('FK_197fb1f1c0a0e6110c378131e26'))) {
        ...
        if (!(await constraintExists('FK_cef8e1c355b902ed1b9f6cfec53'))) {
        ...
        if (!(await constraintExists('FK_dd1116d15dae5959ad992a6707d'))) {
        ...
        if (!(await constraintExists('FK_2809b570ecddeed52cd2d4058e7'))) {
        ...
        if (!(await constraintExists('FK_0d50d9c8f5727b366a284104b71'))) {
        ...
        if (!(await constraintExists('FK_7b670798feb3196663f9a581cc9'))) {
        ...
        if (!(await constraintExists('FK_325a36bd104daa11a3d4542afa9'))) {
        ...
        if (!(await constraintExists('FK_113b3f1b26fc2e3deb2eb9fe1a2'))) {
        ...
        if (!(await constraintExists('FK_ba17e62b98176a43e1703b9b45a'))) {
